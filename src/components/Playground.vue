...
<template>
  <div class="pg" id="playground">
    <div class="pg-card">
      ...
      <p class="pg-hint">
        7 桁の数字を入力すると
        <code class="mono" style="color: var(--red)">/p/{prefix}.json</code>
        を fetch して該当エントリを抽出します。
      </p>
    </div>
    ...
    <div class="pg-result">
      <div class="pg-result-head">
        ...
        <span class="mono">{{ metaLabel }}</span>
      </div>
