...
<span class="v">entry</span> = Jpzip.<span class="f">lookup</span>(<span class="s">"2310831"</span>)
...
<span class="v">var</span> entry = Jpzip.<span class="f">lookup</span>(<span class="s">"2310831"</span>);
...
<span class="v">$entry</span> = <span class="f">lookup</span>(<span class="s">"2310831"</span>);
<span class="c">// → ZipcodeEntry { prefecture: "神奈川県", city: "横浜市中区", ... }</span>
...
<span class="k">let</span> <span class="v">entry</span> = <span class="k">try await</span> <span class="f">lookup</span>(<span class="s">"2310831"</span>)
<span class="c">// → ZipcodeEntry(prefecture: "神奈川県", city: "横浜市中区", ...)</span>
